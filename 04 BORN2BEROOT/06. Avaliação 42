...
Por fim, tente executar um comando via sudo. Veja se o(s) arquivo(s) na pasta "/var/log/sudo/" foram atualizados. Se algo não funcionar como esperado ou não for explicado claramente, a avaliação para aqui.
